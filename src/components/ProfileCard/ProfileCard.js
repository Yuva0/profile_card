...
const ProfileCard = () => {
  return (
    <div className="profile-card">
      <img className="profile-card-img" src={profileImg} alt="Profile"></img>
      <div className="profile-card-title">Sarah Dole</div>
      <div className="profile-card-job">Front End Engineer @ Microsoft</div>
